              ...
              <div class="row">
                ...
                <div class="col-md-6 pl-1">
                  <div class="form-group">
                    ...
                    <input type="text" name="ramo" id="ramo" class="form-control" placeholder="Ramo"
                      value="<?php echo set_value('ramo'); ?>">
                ...
                <div class="col-md-6 pr-1">
                  <div class="form-group">
                    ...
                    <input type="text" name="responsavel" id="responsavel" class="form-control"
                      placeholder="Responsável" value="<?php echo set_value('responsavel'); ?>">
