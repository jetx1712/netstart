    ...
    <div class="carousel-inner">
      ...
      <?php foreach ($banners as $row) : ?>
        <div class="carousel-item <?php echo ($count == 0) ? 'active' : ''; ?>">
          <?php $count++; ?>
          <img class="w-100 d-block" src="<?php echo base_url() ?>painel/assets/build/img/banners/<?php echo $row->big ?> " alt="<?php echo $row->description; ?>">
        </div>
      <?php endforeach; ?>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-7 our-content-container">
        ...
        <div class="row">
          <div class="col-md-12">
            <a class="our-content-speedtest" href="<?php echo base_url(); ?>blog/<?php echo $row->url_friendly ?>">
