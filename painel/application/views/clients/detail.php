...
<div class="wrapper ">
              ...
              <div class="row">
                <div class="col-md-6 pr-1">
                  <div class="form-group">
                    ...
                    <input type="text" name="ramo" id="ramo" class="form-control" placeholder="Empreendimento"
                      value="<?php echo $cliente->ramo?>">
                  </div>
                </div>
                <div class="col-md-6 pl-1">
                  <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <input type="checkbox" name="construtora" id="construtora"
                      <?php if ($cliente->construtora) { echo "checked"; }?>>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea name="observacao" id="observacao"
                      class="form-control textarea"><?php echo $cliente->observacao?></textarea>
                  </div>
                </div>
              </div>
              <div class="row">
            ...
            <table class="table table-striped" id="tabeladois">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo base_url()?>palestras/detalhe/<?php echo $row->id?>"><i
                        class="nc-icon nc-zoom-split"></a></i>
                  </td>
                </tr>
                <?php endforeach; ?>
              </tbody>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            ...
            <button type="button" class="btn btn-primary" name="button" data-toggle="modal"
              data-target="#modalAddHistorico">Adicionar historico</button>
          </div>
          <div class="card-body">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            ...
            <button type="button" class="btn btn-primary" name="button" data-toggle="modal"
              data-target="#modalAddEndereco">Adicionar endereço</button>
          </div>
          <div class="card-body">
  ...
  <div class="modal fade" id="modalAddEndereco" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <form class="" action="<?php echo base_url()?>clientes/cadastrar_endereco" method="post">
            <div class="form-group">
              ...
              <input type="text" class="col-md-12" name="cep" id="cep" size="10" maxlength="9"
  ...
  <div class="modal fade" id="modalAddHistorico" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea name="mensagem" id="mensagem" class="form-control textarea"
                    style="max-height: 800px !important; height: 200px !important;"></textarea>
                </div>
              </div>
            </div>
            <div class="row">
  ...
  <div class="modal fade" id="modalAddContato" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
